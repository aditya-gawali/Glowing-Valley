...
<head>
    ...
    <title>Glowing Valley | Shop All</title>
...
<body class="relative">
    ...
    <div class="py-5 px-5 md:px-20 flex flex-col gap-4 ">
        <h1 class="text-center text-2xl md:text-3xl font-bold py-4">All Products</h1>

        <!-- <div class="flex flex-row gap-4 hover:cursor-pointer pb-5 font-bold overflow-x-scroll px-4 md:flex-wrap">
