    ...
    <div class="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div class="mt-4 flex items-end justify-between">
            <div>
                <h4 class="text-title-md font-bold text-black dark:text-white">
                    <?php
                    $total_p = $conn->query("SELECT count(*) from products where category = 1");

                    echo $total_p->fetchColumn();
                    ?>
                </h4>
                <span class="text-sm font-medium">Total Beauty Product</span>
            </div>
    ...
    <div class="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div class="mt-4 flex items-end justify-between">
            <div>
                <h4 class="text-title-md font-bold text-black dark:text-white">
                    <?php
                    $total_p = $conn->query("SELECT count(*) from products where category = 2");

                    echo $total_p->fetchColumn();
                    ?>
                </h4>
                <span class="text-sm font-medium">Total Hamper Product</span>
            </div>
